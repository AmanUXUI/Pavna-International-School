...
const PurpleEducationIcon: FC = () => (
  <svg viewBox="0 0 100 100" className="w-full h-full" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M26 53 C26 51 28 50 31 50 C38 50 45 53 50 56 C55 53 62 50 69 50 C72 50 74 51 74 53 V67 C74 69 72 70 69 70 C62 70 55 67 50 64 C45 67 38 70 31 70 C28 70 26 69 26 67 V53 Z" fill="#7C3AED" />
    <path d="M50 56 V64" stroke="#EFEBFF" strokeWidth="2.5" strokeLinecap="round" />
  </svg>
);
...
const BlueShieldIcon: FC = () => (
  <svg viewBox="0 0 100 100" className="w-full h-full" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M50 22 C62 22 72 25 72 25 C72 25 72 47 72 53 C72 65 62 73 50 78 C38 73 28 65 28 53 C28 47 28 25 28 25 C28 25 38 22 50 22 Z" fill="#2563EB" />
    <path d="M50 40.5 C52.5 37 57.5 37 59.5 40.5 C61.5 45 50 53 50 53 C50 53 38.5 45 40.5 40.5 C42.5 37 47.5 37 50 40.5 Z" fill="#E0F2FE" />
  </svg>
);
...
const GreenMealIcon: FC = () => (
  <svg viewBox="0 0 100 100" className="w-full h-full" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="28" y="28" width="44" height="44" rx="10" stroke="#059669" strokeWidth="8" fill="none" />
...
const BoardingPage: FC = () => {
  ...
  const FACILITIES: FacilityTab[] = [
    {
      ...
      image: "https://pavnaschool.com/wp-content/uploads/2026/04/OverlayShadow-16.webp",
      icon: Leaf
    },
    {
      id: "ac-rooms",
      ...
      image: "https://pavnaschool.com/wp-content/uploads/2026/04/OverlayShadow-17.webp",
      icon: Snowflake
    },
    {
      id: "apple-school",
    ...
    },
    {
      ...
      description: "From horse riding, lawn tennis, and handball to a wide array of indoor and outdoor sports, our world-class infrastructure is designed to help every child discover and nurture their true athletic potential.",
      image: "https://pavnaschool.com/wp-content/uploads/2026/04/OverlayShadow-18.webp",
      icon: Activity
    },
    {
      id: "co-curricular",
      ...
      description: "Pottery, sculpture, textile design, and industrial design are just the beginning. Our diverse range of co-curricular activities empowers students to explore their passions, staying creatively vibrant and emotionally grounded.",
      image: "https://pavnaschool.com/wp-content/uploads/2026/04/OverlayShadow-19.webp",
      icon: Palette
    },
    {
      ...
      image: "https://pavnaschool.com/wp-content/uploads/2026/04/OverlayShadow-20.webp",
      icon: Smile
    },
    {
      id: "veg-dining",
      ...
      image: "https://pavnaschool.com/wp-content/uploads/2026/04/OverlayShadow-22.webp",
      icon: Utensils
    },
    {
  ...
  const currentItem = FACILITIES.find(item => item.id === activeTab) || FACILITIES[0];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center">
              ...
              <div className="space-y-6 text-[#4B5563] text-[16px] leading-[26px] font-medium font-gill">
                <p>
                  There are many myths about boarding schools, often surrounded by half-truths, such as the idea that they are cold, disconnected, or only suitable for children whose parents are unavailable. The truth about boarding schools, especially modern ones like Pavna, is far more rewarding.
                </p>
                <p>
                  Today's boarding school environment is very different from traditional models. It is warm, well-structured, and deeply intentional, where children develop independence, time management, resilience, and meaningful social connections, qualities that extend well beyond the classroom.
                </p>
                <p>
                  Research reflects that boarding students often demonstrate stronger academic discipline, emotional intelligence, and long-term career readiness. At Pavna School Boarding Campus, we have created a place where children don't simply study, they discover who they are, what they love, and how to pursue it with integrity.
                </p>
              </div>
            </div>
              ...
              >
                ...
                <div className="mt-auto relative z-10">
                  ...
                  <div className="flex items-center gap-4 bg-white/5 p-4 rounded-2xl border border-white/10">
                    ...
                    <div>
                      <h4 className="font-bold text-xs uppercase tracking-widest text-brand-orange">Pavna School Philosophy</h4>
                      <p className="text-sm font-semibold text-white/80">CORE BELIEF</p>
                    </div>
                  </div>
                </div>
              </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              {
                title: "Air Conditioned Triple-sharing rooms with attached bathrooms",
                desc: "",
                icon: PinkBedIcon
              }
            ].map((item, i) => {
              ...
              {FACILITIES.map((facility) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`transition-transform duration-300 ${isActive ? "text-brand-orange translate-x-1" : "text-neutral-400 group-hover:text-brand-orange group-hover:translate-x-1"}`}>
            ...
            <div className="lg:col-span-6 flex flex-col justify-center relative overflow-hidden">
              <div className="w-full overflow-hidden py-4 px-1">
                <motion.div
                  ...
                  animate={{ x: `calc(-${slideIndex * 50}% - ${slideIndex * 8}px)` }}
